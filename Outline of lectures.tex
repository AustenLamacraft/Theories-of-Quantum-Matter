...
Coulomb interactions. When perturbations attack 1. Hubbard--Stratonovich treatment of RPA. Recover dielectric function. How do we get at the functional determinant in the simplest way? Perhaps just be expanding the density in terms of the Coulomb field -- this makes the closest connection to a response function.
...
Heisenberg's problem as a first encounter with the idea of renormalization. When perturbations attack 2. Cooper divergences. BCS theory. Anderson spin picture.
...
Gross--Pitaevskii. When perturbations attack 3. Bogoliubov theory and superfluidity. \verb|Gross--Pitaevskii in traps. Vortex lattices.|
